  ...
  render() {
    return (
      <View style={styles.tela}>
        <ImageBackground
          source={require('../imgs/bg_programacao_1.0.jpg')}
            ...
            <View style={styles.caixas}>
              <View style={styles.caixaInfo}>
                <Text style={styles.descricaoBtn}>
                  Uma competição de programação estimulando raciocínio lógico, trabalho em equipe,
                  resolução de problemas, empreendedorismo e criatividade. O projeto não oferece
                  custos para os colégios subsidiados.
