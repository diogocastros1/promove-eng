  ...
  render() {
    return (
      <View style={styles.tela}>
        ...
        <ImageBackground
          source={require('../imgs/bg_bolsas.jpg')}
          style={styles.background}
        >
          <View style={styles.body}>
            <View style={styles.botoes}>
              <TouchableHighlight
                onPress={() => { Actions.tiposDeBolsas() }}
                style={styles.caixaBtn}
                underlayColor='rgba(12,165,143,0.5)'
              >
                <View>
                  <Text style={styles.tituloBtn}>Tipos de Bolsas</Text>
                  {/* <Text style={styles.descricaoBtn}>conheça um pouco mais sobre o Inatel</Text> */}
                </View>
              </TouchableHighlight>

              <TouchableHighlight
                onPress={() => { Actions.simuladorDeBolsas() }}
                style={styles.caixaBtn}
                underlayColor='rgba(12,165,143,0.5)'
              >
                <View>
                  <Text style={styles.tituloBtn}>Simulador de Bolsas</Text>
            ...
            <View style={styles.botoes}>
              <TouchableHighlight
                onPress={() => { Actions.fichaSocial() }}
                style={[styles.caixaBtn, {backgroundColor:'#FC7A26'}]}
                underlayColor='rgba(12,165,143,0.5)'
              >
                <View>
                  <Text style={styles.tituloBtn}>Preencha a ficha social</Text>
                  {/* <Text style={styles.descricaoBtn}>conheça um pouco mais sobre o Inatel</Text> */}
                </View>
              </TouchableHighlight>
            </View>
