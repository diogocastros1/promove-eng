...
import { selecaoSimulado } from '../../store/actions/provas'
...
class Simulado extends Component {
  ...
  componentDidMount = () => {
    this.props.onSelecaoSimulado(1)
...
const mapDispatchToProps = (dispatch) => {
  return {
    onSelecaoSimulado: (num) => dispatch(selecaoSimulado(num))
  }
}

export default connect(mapStateToProps, mapDispatchToProps)(Simulado)
