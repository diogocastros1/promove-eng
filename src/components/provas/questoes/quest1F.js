...
//Questão nº 1 de fisica prova julho/2018

class Quest1F extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest1F</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              Você está dirigindo um veículo, de 1200 kg, em uma estrada plana, 
              entra numa curva de raio igual a 40 m a uma velocidade máxima de 54 km/h. 
              O coeficiente de atrito estático entre o asfalto seco e os pneus, 
              que irá contribuir para o surgimento da força capaz de manter o veículo 
              sobre a pista sem que derrape, é de:
              </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>0,25</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>0,36</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>0,48</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>0,56</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>0,73</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest1F)
