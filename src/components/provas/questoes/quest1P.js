...
//Questão nº 2 de portugues prova julho/2018

class Quest1P extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest1P</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
            Alto, ruivo nos cabelos.
            </Text>
            <Text style={styles.txtQuestoes}>
            Considerando o enunciado acima, a mesma estrutura sintática é observada em:
            </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>Fraco, sempre mudando de roupa por conta do suor;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>Barrigão, assim como você, cheio de gorduras;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>Quando chegou, estava bem magro;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>Que não gosta muito de comida de sal;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>Estava ficando obeso.</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest1P)
