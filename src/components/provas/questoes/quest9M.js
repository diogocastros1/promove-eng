...
//Questão nº 29 de matematica prova julho/2018

class Quest9M extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest9M</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              Carla trabalha em um restaurante italiano e tem um desafio. Ela
              precisa descobrir quantas macarronadas distintas consegue fazer,
              usando cinco tipos diferentes de ingredientes. Assinale a alternativa
              que apresenta a resposta correta para o desafio.
            </Text>
            ...
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>24</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>31</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>21</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>42</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest9M)
