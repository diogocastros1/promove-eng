...
//Questão nº 30 de matematica prova julho/2018

class Quest10M extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest10M</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              Um engenheiro coordena a construção de uma rodovia no interior
              do estado de Minas Gerais. A rodovia, quando concluída, terá 600km
              de comprimento. Em seis meses, foram construídos 180km da rodovia.
              Admitindo-se que o ritmo de trabalho continue o mesmo, assinale a
              alternativa que apresenta quantos meses ainda faltam para que a
              rodovia seja completamente construída.
            </Text>
            ...
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>20 meses</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>16 meses</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>30 meses</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>12 meses</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>14 meses</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest10M)
