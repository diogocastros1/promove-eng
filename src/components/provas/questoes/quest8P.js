...
//Questão nº 7 de portugues prova julho/2018

class Quest7P extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest7P</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              A alcunha ‘Príncipe dos Poetas’ foi atribuída a:
            </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>Alphonsus de Guimaraens;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>Castro Alves;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>Olavo Bilac;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>João Cabral de Melo Neto;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest7P)
