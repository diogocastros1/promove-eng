...
//Questão nº 11 de fisica prova julho/2018

class Quest6F extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest6F</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
            Um reservatório cilíndrico de 100cm de diâmetro e 6m de altura contém 
            um determinado líquido até 2/3 de seu volume. Considere pi = 3. 
            Sabe-se que a massa do líquido contido no reservatório é de 2,4 toneladas,
            assinale a alternativa que representa a densidade deste líquido, em kg/litro:
              </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>1 kg/l</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>0,8 kg/l</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>0,6 kg/l</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>2,4 kg/l</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>4,8 kg/l</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest6F)
