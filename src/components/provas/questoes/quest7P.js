...
//Questão nº 10 de portugues prova julho/2018
        ...
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              Abaixo, todas as palavras são sinônimos de ‘intróito’, exceto:
            </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>prelúdio;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>proêmio;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>exórdio;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>princípio;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>iniciação.</Text>
            </View>
          </View>
        </View>
      </ScrollView>
