...
//Questão nº 2 de fisica prova julho/2018

class Quest11F extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest11F</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              Em laboratório, você realiza experiências que comprovam a força
              elástica das molas. Você usa de suas mãos para esticar uma mola
              até uma posição de mola esticada x a partir de sua posição de equilíbrio
              e, a seguir, a leva lentamente de volta à posição de equilíbrio.
              Assim, pode-se afirmar que o trabalho realizado pelas mãos é:
              </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>-(k.x²)/2</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
            ...
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>zero</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>-(m.v²)/2, em que v é a velocidade 
              da mão.</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>(m.v²)/2+(k.x²)/2</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest11F)
