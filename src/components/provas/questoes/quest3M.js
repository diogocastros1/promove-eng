...
//Questão nº 19 de matematica prova julho/2018

class Quest3M extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest3M</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
            A equação x²+y²-4x+2y-4=0 descreve uma circunferência de raio:
            </Text>
            ...
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>2</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
            ...
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>4</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>9</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest3M)
