...
//Questão nº 23 de matematica prova julho/2018

class Quest5M extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest5M</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              O volume de uma esfera é o triplo do volume de um cilindro.
              Sabendo que o raio da esfera é o dobro do raio da base do cilindro,
              e que este possui uma altura de 16 cm, pode-se afirmar que o raio
            ...
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>4,5 cm</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>9 cm</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>18 cm</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>3 cm</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>7,5 cm</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest5M)
