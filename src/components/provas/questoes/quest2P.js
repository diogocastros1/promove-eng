...
//Questão nº 3 de portugues prova julho/2018

class Quest2P extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest2P</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              A nova regra anunciava a rápida resolução da situação em curso
              contra os inadimplentes. Mas também prenunciava uma nova
              problemática, por conta das implicações legais.
            </Text>
            <Text style={styles.txtQuestoes}>
              A frase acima exprime:
            </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>contrate;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>explicação;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>alternância;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>conclusão;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>adição.</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest2P)
