...
//Questão nº 4 de portugues prova julho/2018

class Quest3P extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest3P</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              Sem dúvida, as ruas se esvaziaram e acabaram, o trânsito estancou,
              as casas inundadas, a cidade caótica.
            </Text>
            <Text style={styles.txtQuestoes}>
              A classificação sintática da oração é:
            </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>coordenada sindética aditiva;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>coordenada sindética adversativa;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>coordenada sindética conclusiva;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>coordenada assindética;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>NDA.</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest3P)
