...
//Questão nº 5 de fisica prova julho/2018

class Quest3F extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest3F</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
            Um termômetro, graduado na escala Celsius, apresentando um defeito 
            indica -2ºC para a fusão do gelo e 108ºC para ebulição da água, todas 
            as medidas sob pressão normal. Qual a única temperatura correta que
            esse termômetro poderá indicar?
              </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>-20ºC</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>0ºC</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>108ºC</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
            ...
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>100ºC</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest3F)
