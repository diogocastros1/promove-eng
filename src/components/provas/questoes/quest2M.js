...
//Questão nº 18 de matematica prova julho/2018

class Quest2M extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest2M</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              Para que a reta que passa pelos pontos A(-1,k ) e B(1,-2) seja
              perpendicular à reta de equação 2y+3x-4=0 , o valor de k deve
              ser:
            </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>1/2</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>-10/3</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>2/3</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>-3/2</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest2M)
