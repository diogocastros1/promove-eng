...
//Questão nº 6 de portugues prova julho/2018

class Quest5P extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest5P</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              Selecione a alternativa que apresenta uma oração subordinada
            ...
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>Ela disse; “eu o desprezo”;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>Não precisamos de ti: sabemos
              trabalhar sozinhos;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>Entendendo que existia um grande
              rol de livros na sala, quis ir vê-los: era louco por livros;
              </Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>Existiam apenas dois meios de 
              entender: incompetência ou desonestidade.</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest5P)
