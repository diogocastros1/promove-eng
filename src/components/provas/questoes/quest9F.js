...
//Questão nº 8 de fisica prova julho/2018

class Quest9F extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest9F</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
            Em um sistema termodinâmico, certa quantidade de gás ideal é confinada 
            em um cilindro. Se o gás sofrer uma compressão adiabática, podemos 
            considerar que:
              </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>A temperatura do gás aumentou e sua 
              densidade diminuiu.</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>O gás perdeu calor para o meio externo.</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>O gás recebeu calor do meio externo.</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>A temperatura do gás diminuiu e sua 
              densidade aumentou.</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest9F)
