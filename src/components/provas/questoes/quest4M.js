...
//Questão nº 21 de matematica prova julho/2018

class Quest4M extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest4M</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              Numa progressão aritmética (PA) a soma dos 20 primeiros termos é
              igual a 920. Sabendo que o oitavo termo é igual a 36, pode-se
              afirmar que a razão desta PA é um número:
            </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>negativo</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>primo</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>múltiplo de 2</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>ímpar</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest4M)
