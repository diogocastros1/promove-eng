...
//Questão nº 10 de fisica prova julho/2018

class Quest5F extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest5F</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
            Um corpo, ligado a uma mola, oscila na horizontal em Movimento 
            Harmônico Simples. É correto afirmar que, nos pontos em que ocorre a
            ...
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>A energia cinética e a aceleração são nulas;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>A velocidade e a energia potencial são nulas;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>A energia cinética é máxima e a energia potencial é mínima;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>O módulo da aceleração e a energia potencial são máximas;</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>O módulo da velocidade e a energia potencial são máximas.</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest5F)
