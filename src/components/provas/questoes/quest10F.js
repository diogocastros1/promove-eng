...
//Questão nº 6 de fisica prova julho/2018

class Quest10F extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest10F</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
              Uma barra de aço, inicialmente a 10ºC, sofre uma dilatação de 0,6 cm,
              quando aquecida até uma temperatura de 110ºC. Sabendo-se que o coeficiente
              de dilatação linear médio do aço, no intervalo de temperatura considerado,
              é 1,2×10^-6 ºC^-1, pode-se afirmar que o comprimento inicial da barra
              antes do aumento de temperatura era:
              </Text>
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>0,5 m</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>5 m</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>50 m</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>50 cm</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>0,5 cm</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest10F)
