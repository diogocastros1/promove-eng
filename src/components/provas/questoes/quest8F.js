...
//Questão nº 14 de fisica prova julho/2018

class Quest8F extends Component {
  state = {
    ...initialState,
  }
    ...
    return (
      <ScrollView style={styles.tela}>
        ...
        <View style={styles.tituloQuest}>
          {/* <Text style={styles.txtTituloQuest}>Quest8F</Text> */}
        </View>
        <View style={styles.body}>
          <View style={styles.questao}>
            <Text style={styles.txtQuestoes}>
            Durante uma tempestade uma pessoa observa a ocorrência de uma descarga 
            elétrica (relâmpago). Este observador mede um intervalo de tempo de 
            6 segundos entre a visão do relâmpago e a audição do trovão. Qual é o 
            valor aproximado da distância do observador em relação ao ponto de 
            ocorrência da descarga elétrica?
            
            Utilizar os valores aproximados: 
            velocidade do som no ar: 340 m/s e 
            ...
            <View style={styles.letras}>
              ...
              />
              <Text style={styles.txtLetras}>57 m</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>0,9 km</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>2 km</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>204 km</Text>
            </View>
            <View style={styles.letras}>
              <CheckBox
              ...
              />
              <Text style={styles.txtLetras}>21 km</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Quest8F)
